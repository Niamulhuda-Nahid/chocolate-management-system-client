...
const UpdateChocolate = () => {
    ...
    const { _id, name, photo, category, country } = loadedChocolate;
                ...
                <div className='bg-slate-200 w-[90%] mx-auto mb-9 rounded-lg'>
                    <div >
                        <div className='text-center py-9'>
                            <h3 className='text-2xl font font-semibold'>Update Chocolates</h3>
                            <p className='text-gray-500 mt-2'>Use the below form to update a product</p>
                        </div>
                        <form onSubmit={handleUpdateChocolate} className='w-[80%] mx-auto pb-9'>
                            <div className="form-control">
                                <label className="label">
                                    <span className="font-semibold">Name</span>
                                </label>
                                <input type="text" name='name' placeholder="Hot Pink Chocolate" defaultValue={name} className="input rounded" required />
                            </div>
                            <div className="form-control mt-4">
                                <label className="label">
                                    <span className="font-semibold">Country</span>
                                </label>
                                <input type="text" name='country' placeholder="Enter Country Name" defaultValue={country} className="input rounded" required />
                            </div>
                            <div className="form-control mt-4">
                                <label className="label">
                            ...
                            <div className="form-control mt-4">
                                ...
                                <input type="text" name='photo' placeholder="Enter Photo URL" defaultValue={photo} className="input rounded" required />
                            </div>
                                <button id='save-btn' className='bg-[#8a4c0a] w-full mt-7 py-2 text-white text-lg font-semibold tracking-wide rounded' >Save</button>
                        </form>
                    </div>
                </div>
            </div>
